...
def main():
    ...
    print("Imageimporter_large time: ", time.time()-a)
    a = time.time()
    checkpoint_nobinary(stack)
    print("checkpoint_nobinary time: ", time.time()-a)
    print ('Padding images\n')
    a = time.time()
    stack = add_z_padding(stack)  # adds 2 planes in the beginning and end
    print("add_z_padding time: ", time.time()-a)
    ...
    print("augment_package time: ", time.time()-a)
