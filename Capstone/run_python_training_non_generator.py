...
for file_name in all_h5_files:
        ...
        #image_generator = image_datagen.flow(X_train, y_train, , batch_size=16, shuffle=False, sample_weight=None, seed=None, save_to_dir=None, save_prefix='', save_format='png', subset=None)
        ...
        model.fit(x=X_train, y=y_train, batch_size=128, epochs=int(numberOfIterations/len(all_h5_files)), verbose=1, callbacks=[model_checkpoint], validation_split=0.0, validation_data=(X_val,y_val), shuffle=False, class_weight=None, sample_weight=None, initial_epoch=0, steps_per_epoch=None, validation_steps=None)
        #model.fit(x=X_train, y=y_train, batch_size=None, epochs=int(numberOfIterations/len(all_h5_files)), verbose=1, callbacks=[model_checkpoint], validation_split=0.0, shuffle=False, class_weight=None, sample_weight=None, initial_epoch=3, steps_per_epoch=batch_size)                                                                   
